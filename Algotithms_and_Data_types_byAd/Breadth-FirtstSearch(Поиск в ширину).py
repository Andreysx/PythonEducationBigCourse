...
# Если путь существует, поиск в ширину определяет кратчайший путь(потому что сначала обходятся все связи первого уровня, потом все связи второго уровня, потом третьего.)
