...
# Если нет базового случая - стек переполняется (ошибка StackOverflow)
...
def fact(n):
    ...
    return fact(n - 1) * n  # рекурсивный вызов(как правило происходит изменение аргумента вызова, чтобы при новом вызове приблизится к базовому случаю)
...
# Если пишете рекрсивную функцию в которой задействован массив(список), базовый случай - пустой массив или массив из одного элемента!
#
